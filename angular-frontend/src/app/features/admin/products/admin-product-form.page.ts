      ...
      <div class="md:col-span-2 card p-4 grid gap-3">
        ...
        <div class="grid-2" *ngIf="!form.hasVariants">
          <div>
            ...
            <input class="inp" type="number" min="0" [(ngModel)]="form.price" [required]="!form.hasVariants">
          </div>
          <div>
...
export class AdminProductWizardPageComponent implements OnInit {
  ...
  // KHÔNG có field stock trong ProductRequest
  form: ProductRequest = {
  ...
  // tồn kho hiện tại (product-level)
  ...
  basicValid = computed(() =>
    ...
    (this.form.hasVariants ? true : (this.form.price != null && this.form.price >= 0))
  );
  ...
  saveBasic(next: boolean) {
    ...
    const body: ProductRequest = {
      ...
      price: this.form.hasVariants ? 0 : Number(this.form.price || 0),
      salePrice: this.form.hasVariants ? null : (this.form.salePrice != null ? Number(this.form.salePrice) : null),
